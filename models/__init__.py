...
class Bianchi(sciunit.Model,
    ...
    def __init__(self, name="Bianchi"):
        ...
        self.modelpath = "./models/hoc_models/Ca1_Bianchi/experiment/"
        libpath = "x86_64/.libs/libnrnmech.so.0"

        if os.path.isfile(self.modelpath + libpath) is False:
            os.system("cd " + self.modelpath + "; nrnivmodl")

        h.nrn_load_dll(self.modelpath + libpath)
    ...
    def initialise(self):
        # load cell
        h.load_file(self.modelpath + "basic.hoc")
